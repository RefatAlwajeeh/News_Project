...
include('includes/config.php');
    ...
    require_once ("../mvc/PostController.php");
    require_once ("../mvc/CatController.php");
    require_once ("../mvc/UserController.php");

    $art_controller = new PostController();
    $cat_controller = new CatController();
    $user_controller = new UserController();

error_reporting(0);
if(strlen($_SESSION['login'])==0)
//if(strlen($_SESSION['Type'])=='Admin')
  {
...
<a href="manage-categories.php">
                            ...
                            <?php
                            $query = $cat_controller->getCat('1');

                            $countcat = count($query);
...
<a href="manage-user.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Listed Usrs</p>

                                        <?php
//                                        $query=mysqli_query($con,"select * from tblsubcategory where Is_Active=1");
                                        $query =  $user_controller->getUsers('1');
                                        $countuser=count($query);
                                        ?>

                                        <h2><?php echo htmlentities($countuser);?> <small></small></h2>
     ...
     <a href="manage-posts.php">                       
        <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                   ...
                                   <?php $query= $art_controller->get_all_art();

                                      $countposts=count($query);
?>
